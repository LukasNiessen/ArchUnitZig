...
pub const GraphCache = extraction.GraphCache;
pub const GraphCacheKey = extraction.GraphCacheKey;
...
pub const buildGraphCacheKey = extraction.buildGraphCacheKey;
pub const classifyReference = extraction.classifyReference;
pub const clearGraphCache = extraction.clearGraphCache;
pub const cloneGraphFromCache = extraction.cloneGraphFromCache;
...
pub const storeGraphInCache = extraction.storeGraphInCache;
